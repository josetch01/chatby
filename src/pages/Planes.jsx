            ...
            {planes.map((plan, index) => (
              <div
                ...
                className={` relative rounded-3xl p-[2px] transition-all duration-300 overflow-hidden ${
                  plan.destacado
                    ? "transform lg:scale-100 shadow-2xl  dark:bg-gradient-to-b dark:from-[#2a3441] dark:via-[#F129A1] dark:to-[#F129A1] bg-gradient-to-b from-[#ffffff] via-[#f9d2e5] to-[#fce4f6]"
